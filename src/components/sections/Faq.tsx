...
const faqs = [
  {
    ...
    a: "전용 마스코트, 매월 웹툰, 로고·컬러·템플릿이 담긴 디자인 시스템(BrandDNA), 그리고 월 정기 디자인(요청 시 1회 기준)과 SNS 홍보물 템플릿까지. 디자인 팀이 없어도 매달 완성된 브랜드 콘텐츠를 받아보실 수 있습니다.",
  },
  {
  ...
  },
  {
    ...
    a: "노란발자국·노란볼라드 등 친환경 노면표시재와 안전표지의 제작·시공부터, 주기적인 점검·교체, CPTED(범죄예방) 기반 안전 디자인 제안까지 정기적으로 관리해 드립니다.",
  },
  {
