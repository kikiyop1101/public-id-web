...
> = {
  ...
  installed: { label: "설치 완료", pin: "#C8D820", text: "#5E6E00", bg: "rgba(200,216,32,0.22)" },
  managed: { label: "관리중", pin: "#08A0B8", text: "#0B6C7D", bg: "rgba(8,160,184,0.12)" },
  ended: { label: "관리 종료", pin: "#DC2626", text: "#B91C1C", bg: "rgba(220,38,38,0.12)" },
  demolished: { label: "철거 완료", pin: "#FFE000", text: "#8A6A00", bg: "rgba(255,224,0,0.22)" },
};
