...
export const news: NewsItem[] = [
  {
    ...
    body: [
      "사회적기업이자 KIDP 5부문 산업디자인전문회사인 ㈜퍼블릭아이디(대표 조용민)는 여름방학을 앞두고 어린이보호구역(스쿨존) 노면표시·안전표지의 점검·정비 수요에 대응한다고 밝혔다.",
  ...
  },
  {
    ...
    body: [
      "사회적기업이자 KIDP 5부문 산업디자인전문회사인 ㈜퍼블릭아이디(대표 조용민)는 자체 디자인 안전표지 700종 카탈로그를 구축하고 온라인 판매 채널을 순차 확대한다고 밝혔다.",
  ...
  },
  {
    ...
    body: [
      "사회적기업이자 KIDP 5부문 산업디자인전문회사인 ㈜퍼블릭아이디(대표 조용민)가 디자인 인력을 두기 어려운 공공기관·기업·소상공인을 위한 디자인구독 서비스를 알리는 데 나섰다.",
      ...
      "KIDP 산업디자인전문회사 신고 5부문(시각·환경·포장·제품·종합)을 모두 갖춰 시각 콘텐츠부터 공간 안내(웨이파인딩), 제품·포장까지 한 회사 안에서 이어지는 것도 특징이다. 실제로 퍼블릭아이디는 여러 공공기관·지방자치단체·NGO 그리고 많은 기업들과 마스코트·웹툰·안내 디자인 작업을 함께해 왔다.",
