...
export const news: NewsItem[] = [
  {
    ...
    body: [
      ...
      "학부모나 지역 주민이 통학로에서 위험하다고 느낀 지점을 사진과 위치로 제보하면, 회사가 해당 지역 통학로를 살펴 무료 진단 리포트를 작성해 관할 지방자치단체와 학교에 전달하는 방식이다. 개선이 이뤄진 지점은 전후 사진으로 캠페인 페이지에 공개한다. 제보에 따른 사은품이나 금전적 보상은 없다. 캠페인은 특정 지역에 한정하지 않고 전국을 대상으로 접수하며, 제보 페이지는 store.public-id.co.kr/safety-report다.",
