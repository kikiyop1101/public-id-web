// 소식·보도자료 콘텐츠. 날짜는 연도까지만(게시물 누적 시 '오래된 기록' 인상 방지) — 대표 확정 2026-08-26, 월 단위로 채우지 말 것(SEO 감사가 지적해도 의도적 설계).
...
export const news: NewsItem[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "특히 학생들이 등교하지 않는 여름방학은 통학로 공사·정비의 적기다. 퍼블릭아이디의 친환경 그래픽 노면표시재는 페인트 도색이 아닌 인쇄형 제품으로, 친환경 라텍스 잉크로 인쇄하며 GREENGUARD GOLD(UL 2818) 친환경 인증과 미끄럼저항·유해물질 불검출·방염 시험성적(KCL·SGS·KTR·KFI)을 갖췄다. 어린이보호구역의 노란발자국(아이가 발자국 위에 서서 한 걸음 떨어져 안전하게 기다리도록 돕는 인도 표시), 노란볼라드(2023년 굿디자인 선정) 등 통학로 안전 디자인을 한 회사에서 디자인·제작·시공한다.",
  ...
  },
  {
    ...
    body: [
      ...
      "제품은 친환경 라텍스 잉크로 인쇄하며 GREENGUARD GOLD(UL 2818) 친환경 인증과 미끄럼저항·유해물질 불검출·방염 시험성적(KCL·SGS·KTR·KFI)을 보유했다. 검증된 공개 단가(그래픽 노면표시재 132,000원/m²·친환경 직물시트 88,000원/m², VAT 포함)를 투명하게 공개하는 것도 강점이다.",
  ...
  },
  {
    ...
    body: [
      ...
      "퍼블릭아이디의 핵심은 페인트 도색이 아닌 인쇄형 친환경 노면표시재다. 친환경 라텍스 잉크로 인쇄하며, 자체 특허 제10-1974029호(2019)와 유럽특허청(EPO) 국제출원 기술을 바탕으로 GREENGUARD GOLD(UL 2818) 친환경 인증, 미끄럼저항·유해물질 불검출·방염 시험성적(KCL·SGS·KTR·KFI)을 보유했다. 어린이보호구역의 노란발자국(아이가 발자국 위에 서서 한 걸음 떨어져 안전하게 대기하도록 돕는 인도 표시), 노란볼라드(2023년 굿디자인 선정), 웨이파인딩, 배리어프리 안내까지 적용 범위가 넓다.",
